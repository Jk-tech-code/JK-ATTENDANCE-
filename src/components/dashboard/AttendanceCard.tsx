...
import { useTodayAttendance, useCheckOut, useUndoCheckOut } from '@/hooks/useAttendance'
            ...
            {attendance.attendance_status === 'EARLY_DEPARTURE' &&
              ...
              attendance.early_departure_minutes > 0 && (
                <p className="text-xs text-orange-600">
                  Left {attendance.early_departure_minutes} minute
                  {attendance.early_departure_minutes !== 1 ? 's' : ''} early
                </p>
              )}
