      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={() => openCreate('holiday')}>
              <Umbrella className="mr-2 h-4 w-4" />
              Add Holiday
            </Button>
            <Button variant="outline" onClick={() => openCreate('event')}>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                {filter === 'all' ? 'All Entries' : filter === 'holiday' ? 'Holidays' : 'Events'}
              </CardTitle>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                ...
                <p className="text-center text-muted-foreground py-8">
                  No {filter === 'all' ? 'holidays or events' : filter + 's'} for {year}
                </p>
              ) : (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            {new Date(e.calendar_date + 'T12:00:00').toLocaleDateString('en-US', {
                              weekday: 'short',
                              month: 'short',
                              day: 'numeric',
                              year: 'numeric',
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              >
                <Umbrella className="mr-2 h-4 w-4 text-yellow-600" />
